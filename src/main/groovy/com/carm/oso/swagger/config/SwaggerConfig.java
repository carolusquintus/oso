...
public class SwaggerConfig {
    ...
    public static final List<String> DEFAULT_INCLUDE_PATTERNS = Arrays.asList("/rest/oso-api/.*");
    public static final String SWAGGER_GROUP = "oso-api";
    ...
    private ApiInfo apiInfo() {
        ApiInfo apiInfo = new ApiInfo(
                "Oso API",
                "Application to get user info.",
                "",
                "carloschars@gmail.com",
                "",
                ""
        );
